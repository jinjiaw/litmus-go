...
import (
	...
	litmusLIB "github.com/litmuschaos/litmus-go/chaoslib/litmus/node-cordon/lib"
	"github.com/litmuschaos/litmus-go/pkg/clients"
	"github.com/litmuschaos/litmus-go/pkg/events"
	"github.com/litmuschaos/litmus-go/pkg/log"
	"github.com/litmuschaos/litmus-go/pkg/probe"
	"github.com/litmuschaos/litmus-go/pkg/result"
	experimentEnv "github.com/litmuschaos/litmus-go/pkg/sample-category/node-cordon/environment"
...
// NodeCordon contains steps to inject node-cordon chaos
func NodeCordon(clients clients.ClientSets) {
	...
	if err := result.ChaosResult(&chaosDetails, clients, &resultDetails, "SOT"); err != nil {
		...
		failStep := "Updating the chaos result of node-cordon experiment (SOT)"
	...
	// Including the litmus lib for node-cordon
	switch experimentsDetails.ChaosLib {
	case "litmus":
		if err := litmusLIB.PrepareNodeCordon(&experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
